...
<body>
    ...
    <div class="main-content">
        ...
        <!-- Instructions Management and Recent Activities Row -->
        <div style="display: flex; gap: 24px; margin-bottom: 32px;">
            <!-- Instructions Management -->
            <div class="instructions-management" style="width: 60%; height: 70vh; float: none; margin: 0;">
                <div class="instructions-header">
                    <h3><i class="fas fa-bullhorn"></i> Client Instructions</h3>
                    <p>Upload images for client dashboard (Max: 5 images)</p>
                </div>
                <div class="instructions-upload">
                    <form id="instructionsUploadForm" enctype="multipart/form-data">
                        <div class="upload-area">
                            <input type="file" id="instructionsFile" name="instructions_image" accept="image/*" style="display: none;">
                            <div class="upload-button" onclick="document.getElementById('instructionsFile').click()">
                        ...
                        <button type="submit" class="btn btn-primary" style="margin-top: 12px; padding: 8px 16px; font-size: 0.9rem;">
                    ...
                    <!-- Images Gallery -->
                    <div class="instructions-gallery" id="instructionsGallery" style="margin-top: 20px;">
                        <h4>Uploaded Images (<span id="imageCount">0</span>/5)</h4>
    ...
    <script>
        ...
        function loadGallery() {
            ...
            fetch('get_instructions_images.php')
                ...
                .then(data => {
                    ...
                    data.images.forEach((image, index) => {
                        ...
                        galleryItem.innerHTML = `
                            <img src="${image}" alt="Instruction ${index + 1}">
        ...
        function deleteImage(imagePath) {
            if (confirm('Are you sure you want to delete this image?')) {
                fetch('delete_instruction_image.php', {
                    method: 'POST',
                    headers: {
        ...
        // Instructions upload form handling
        document.getElementById('instructionsUploadForm').addEventListener('submit', function(e) {
            e.preventDefault();
