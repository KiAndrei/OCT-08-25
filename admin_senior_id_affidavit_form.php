...
<head>
    ...
    <title>Affidavit of Loss (Senior ID) Form - Opiña Law Office</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="header-title">
                <h1>Affidavit of Loss (Senior ID) Form</h1>
        ...
        <div class="form-container">
            ...
            <form id="seniorIdForm" method="GET" action="files-generation/generate_affidavit_of_loss_senior_id.php" target="_blank">
    ...
    <script>
        function previewDocument() {
            const form = document.getElementById('seniorIdForm');
            ...
            const previewUrl = `files-generation/generate_affidavit_of_loss_senior_id.php?${params.toString()}`;
