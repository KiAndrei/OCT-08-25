...
<head>
    ...
    <title>Sworn Affidavit of Solo Parent Form - Opiña Law Office</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="header-title">
                <h1>Sworn Affidavit of Solo Parent Form</h1>
    ...
    <script>
        ...
        function toggleEmploymentFields() {
            ...
            employeeAmountField.classList.remove('show');
            selfEmployedAmountField.classList.remove('show');
            unemployedDependentField.classList.remove('show');
            
            // Clear all conditional field values
            document.getElementById('employeeAmount').value = '';
            document.getElementById('selfEmployedAmount').value = '';
            document.getElementById('unemployedDependent').value = '';
            
            // Show relevant field based on selection
            if (employmentSelect.value === 'Employee and earning') {
                employeeAmountField.classList.add('show');
            } else if (employmentSelect.value === 'Self-employed and earning') {
                selfEmployedAmountField.classList.add('show');
            } else if (employmentSelect.value === 'Un-employed and dependent upon') {
        ...
        function previewDocument() {
            ...
            const previewUrl = `files-generation/generate_affidavit_of_solo_parent.php?${params.toString()}`;
