...
<head>
    ...
    <title>Sworn Statement of Mother Form - Opiña Law Office</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="header-title">
                <h1>Sworn Statement of Mother Form</h1>
    ...
    <script>
        function previewDocument() {
            const form = document.getElementById('swornMotherForm');
            ...
            const previewUrl = `files-generation/generate_sworn_statement_of_mother.php?${params.toString()}`;
