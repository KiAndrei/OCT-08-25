...
<body>
    ...
    <div class="sidebar client-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="client_cases.php" class="active" title="Track your legal cases, view case details, and upload documents"><div class="button-content"><i class="fas fa-gavel"></i><span>My Cases</span></div><small>Track Legal Cases</small></a></li>
            ...
            <li><a href="client_messages.php" title="Communicate with your attorney and legal team"><div class="button-content"><i class="fas fa-envelope"></i><span>Messages</span></div><small>Chat with Attorney</small></a></li>
        </ul>
    </div>
