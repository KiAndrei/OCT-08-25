...
<body>
    ...
    <div class="sidebar client-sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="client_dashboard.php" title="View your case overview, statistics, and recent activities"><div class="button-content"><i class="fas fa-home"></i><span>Dashboard</span></div><small>Overview & Statistics</small></a></li>
            <li><a href="client_documents.php" title="Generate legal documents like affidavits and sworn statements"><div class="button-content"><i class="fas fa-file-alt"></i><span>Document Generation</span></div><small>Create Legal Documents</small></a></li>
            <li><a href="client_cases.php" title="Track your legal cases, view case details, and upload documents"><div class="button-content"><i class="fas fa-gavel"></i><span>My Cases</span></div><small>Track Legal Cases</small></a></li>
            <li><a href="client_schedule.php" title="View your upcoming appointments, hearings, and court schedules"><div class="button-content"><i class="fas fa-calendar-alt"></i><span>My Schedule</span></div><small>Appointments & Hearings</small></a></li>
            <li><a href="client_messages.php" class="active" title="Communicate with your attorney and legal team"><div class="button-content"><i class="fas fa-envelope"></i><span>Messages</span></div><small>Chat with Attorney</small></a></li>
        </ul>
    </div>
        ...
        <div class="header">
            ...
            <div class="user-info" style="display: flex; align-items: center; gap: 20px;">
                ...
                <div class="profile-dropdown" style="display: flex; align-items: center; gap: 12px;">
                    <img src="<?= htmlspecialchars($profile_image) ?>" alt="Client" style="object-fit: cover; width: 42px; height: 42px; border-radius: 50%; border: 2px solid var(--primary-color); cursor: pointer;" onclick="toggleProfileDropdown()">
                    
                    <div class="user-details">
                        <h3 style="margin: 0; font-size: 16px; color: var(--primary-color);"><?php echo $_SESSION['client_name']; ?></h3>
    ...
    <script>
        ...
        function editProfile() {
            // This would open an edit profile modal if needed
