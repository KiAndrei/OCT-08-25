...
<div style="font-size:11pt; line-height:1.2;">
    ...
    <div style="text-align:justify; margin-bottom:15px;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;That &nbsp;&nbsp; I, &nbsp; __________________________________, &nbsp; Filipino &nbsp; Citizen, &nbsp; of &nbsp; legal &nbsp; age, single/ married /<br/>
        widow, with residence and postal address at_____________________________________<br/>
        ...
        <div style="margin-left: 40px;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;everything indispensable for his/her/their wellbeing for ________________ year/s now<br>
        ...
        <br>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="border-collapse:collapse;">
                ...
                <tr>
                    <td style="width:16px; vertical-align:top; padding-top:2px;"><div style="width:12px; height:12px; border:1px solid #000;"></div></td>
                    <td>
Self-employed and earning Php <span style="display:inline-block; border-bottom:1px solid #000; width: 160px;"></span> per month,
